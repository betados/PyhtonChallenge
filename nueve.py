...
third = [first[i] + s for i, s in enumerate(second)]
...
puntos = [(first[i], first[i+1]) for i in range(0, len(first)-1, 2)]
puntos2 = [(second[i], second[i+1]) for i in range(0, len(second)-1, 2)]
puntos3 = [(third[i], third[i+1]) for i in range(0, len(third)-1, 2)]
while True:

    screen.fill((0, 0, 0))
    # image = pygame.image.load('text/mosca.jpg')
    # screen.blit(image, (0, 0))
    pygame.draw.lines(screen, (255, 255, 255), True, puntos3, 1)
    pygame.draw.lines(screen, (255, 10, 255), False, puntos, 1)
    pygame.draw.lines(screen, (0, 255, 1), False, puntos2, 1)
